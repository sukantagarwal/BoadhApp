...
const HindirajbhashaPage = () => (
  <>
    <SEO title="Boadh" keywords={[`hindi books`, `boadh`, `hindi books in chennai`]} />
    <StaticQuery query={graphql`
        query HindirajbhashaQuery{
            allHindirajbhashaJson{
                edges{
                    node{
                        Code
                        ISBN
...
function getBookTable(Hindirajbhasha){
    const booksArray = [];
    Hindirajbhasha.allHindirajbhashaJson.edges.forEach(item => 
        booksArray.push(<tr>
...
export default HindirajbhashaPage
