...
const BoadhprakashanPage = () => (
  <>
    <SEO title="Boadh" keywords={[`hindi books`, `boadh`, `hindi books in chennai`]} />
    <StaticQuery query={graphql`
        query BoadhprakashanQuery{
            allBoadhprakashanJson{
                edges{
                    node{
                        Code
                        ISBN
...
function getBookTable(Boadhprakashan){
    const booksArray = [];
    Boadhprakashan.allBoadhprakashanJson.edges.forEach(item => 
        booksArray.push(<tr>
...
export default BoadhprakashanPage
