...
function getBookTable(Childrenbooks){
    const booksArray = [];
    Childrenbooks.allChildrenbooksJson.edges.forEach(item => 
        booksArray.push(<tr>
